...
public class DCMProcessor extends GenericProcessor {
	...
	public static final String SERVICE = "corradodue_masteraip";
	public static final String SYSTEM = "DCMCORRADODUEMASTERAIP";
	...
	public void process(Exchange exchange) throws Exception {
        ...
        if (!result) {
        	log.debug("Check if device is able to send sampling for corradodue_masteraip service");
