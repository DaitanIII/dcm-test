package com.accenture.cpaas.enabler.dcm.corradodue.masteraip.be.access;
...
import com.accenture.cpaas.enabler.dcm.common.cassandra.CassandraClient;
import com.accenture.cpaas.enabler.dcm.common.cassandra.CassandraHelper;
...
public class DcmCqlAccessImpl {
    ...
    public void writeNewSampling(List<List<EntityBean>> entityBeans) throws JsonProcessingException, IOException {
        ...
        log.debug("Save new sampling list for CorradodueMasteraip");
